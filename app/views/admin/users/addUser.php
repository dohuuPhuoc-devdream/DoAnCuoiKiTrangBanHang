                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"
                                        value="<?php echo $user->getUserName() ?? '' ?>" id="userName"
                                        name="userName" />
                                </div>
                                <?php if ($action === 'add'): ?>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email"
                                            value="<?php echo $user->getEmail() ?? ''; ?>" id="email" name="email"
                                            required />
                                    </div>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="<?php echo $user->getCity() ?? '' ?>" id="city" name="city" />
                                    </div>
                                    <div class="form-group">
                                        <label for="district" class="col-form-label">Quận/Huyện</label>
                                        <input class="form-control" type="text"
                                            value="<?php echo $user->getDistrict() ?? '' ?>" id="district"
                                            name="district" />
                                    </div>
                                    <div class="form-group">
                                        <label for="ward" class="col-form-label">Phường/Xã</label>
                                        <input class="form-control" type="text"
                                            value="<?php echo $user->getWard() ?? '' ?>" id="ward" name="ward" />
                                    </div>
                                    <div class="form-group">
                                        <label for="street" class="col-form-label">Số nhà, Tên đường,
                                            Khóm/Ấp</label>
                                        <input class="form-control" type="text"
                                            value="<?php echo $user->getStreet() ?? '' ?>" id="street" name="street" />
                                    </div>
                                    ...
                                    <div class="row mb-3 justify-content-center">
                                        <div
                                            ...
                                            <img src="<?php echo BASE_PATH . '/' . $user->getImage(); ?>" alt="Chưa có ảnh"
                                                id="preview" />
